...
- Allow invalid names in aliases (7d8bef6)

## [0.1.9] - 2026-05-12

### Fixed

- Reference correct source file and name in diagnostics in imported avdl
  files (a0c9932)
...
[Unreleased]: https://github.com/jonhoo/avdl/compare/v0.1.9+1.12.1...HEAD
[0.1.9]: https://github.com/jonhoo/avdl/compare/v0.1.8+1.12.1...v0.1.9+1.12.1
